...
func (ipa *InterPodAffinity) CalculateInterPodAffinityPriority(pod *v1.Pod, nodeNameToInfo map[string]*cache.NodeInfo, nodes []*v1.Node) (schedulerapi.HostPriorityList, error) {
