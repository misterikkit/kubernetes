...
func (s *SelectorSpread) CalculateSpreadPriorityMap(pod *v1.Pod, meta interface{}, nodeInfo *cache.NodeInfo) (schedulerapi.HostPriority, error) {
...
func (s *SelectorSpread) CalculateSpreadPriorityReduce(pod *v1.Pod, meta interface{}, nodeNameToInfo map[string]*cache.NodeInfo, result schedulerapi.HostPriorityList) error {
...
func filteredPod(namespace string, selector labels.Selector, nodeInfo *cache.NodeInfo) (pods []*v1.Pod) {
...
// on given machine
func (s *ServiceAntiAffinity) CalculateAntiAffinityPriorityMap(pod *v1.Pod, meta interface{}, nodeInfo *cache.NodeInfo) (schedulerapi.HostPriority, error) {
...
func (s *ServiceAntiAffinity) CalculateAntiAffinityPriorityReduce(pod *v1.Pod, meta interface{}, nodeNameToInfo map[string]*cache.NodeInfo, result schedulerapi.HostPriorityList) error {
